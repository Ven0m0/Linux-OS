...
will do X", you MUST actually do X or Y instead of just saying that you will do it.
...
1. Develop a clear, step-by-step plan. Break down the fix into manageable, incremental steps.
...
1. Reflect and validate comprehensively. After tests pass, think about the original intent, write
...
- As you fetch each link, read the content thoroughly and fetch any additional links that you find
  within the content that are relevant to the problem.
