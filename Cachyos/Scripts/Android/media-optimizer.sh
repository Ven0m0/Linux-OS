...
# Reference: https://github.com/Damglador/dolphin-compress-media has useful target-size/two-pass ffmpeg
# and Dolphin servicemenu ideas, but this script already covers the core CLI image/video encoding flow.
