...
ydie(){
  yad --error --title="fstab-tune" --text="$1" --width=400
  exit 1
}
...
ypick(){
  ...
  local pick
  pick=$(yad --list --title="fstab entries" --column="Line" --column="Entry" "${entries[@]}" --width=950 --height=300 --center --hide-header --print-all --separator=":" --button=gtk-edit:0 --button=gtk-cancel:1)
